...
public class PotionCow extends PotionBase {
    ...
    public void performEffect(EntityLivingBase entityLivingBase, int amplifier) {
        ...
        if(entityLivingBase.ticksExisted%40==0 && entityLivingBase.world.rand.nextFloat() < 0.30F) {
            entityLivingBase.world.playSound(null, entityLivingBase.posX, entityLivingBase.posY, entityLivingBase.posZ, RegistryHandler.COW, SoundCategory.PLAYERS, 0.9F, (entityLivingBase.world.rand.nextFloat()-entityLivingBase.world.rand.nextFloat())*0.1F+1.0F);
        }
    }
}