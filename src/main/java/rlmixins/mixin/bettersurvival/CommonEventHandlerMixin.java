    ...
    public void onLivingUpdate(LivingEvent.LivingUpdateEvent event) {
        ...
        if(entity instanceof EntityPlayer) {
            if(entity.getHeldItemMainhand().getItem() instanceof ItemNunchaku) {
                INunchakuCombo combo = (INunchakuCombo)entity.getCapability(NunchakuComboProvider.NUNCHAKUCOMBO_CAP, null);
            ...
            else if(movSpeed.hasModifier(SHIELD_KNOCKBACK)
                    || movSpeed.hasModifier(SHIELD_WEIGHT)) {
            ...
            else if(movSpeed.hasModifier(AGILITY)) {
        ...
        if(entity instanceof EntityLiving) {
            ...
            if(follow.hasModifier(BLIND)) {
                follow.removeModifier(followUUID);
            }
