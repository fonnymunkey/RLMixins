...
import rlmixins.client.model.ModelPirateBaubleHat;
 ...
 * By cdstk
 */
public class LayerPirateBaubleHat extends LayerQuarkBaubleHat {

    private static final ModelPirateBaubleHat pirateHat = new ModelPirateBaubleHat();

    public LayerPirateBaubleHat(RenderPlayer renderPlayer) {
        super(renderPlayer);
    }
