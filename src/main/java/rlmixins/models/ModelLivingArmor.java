...
public class ModelLivingArmor extends ModelBiped {
    public ModelRenderer RightLeg;
    public ModelRenderer LeftLeg;
    public ModelRenderer RightFoot;
    public ModelRenderer LeftFoot;

    public ModelLivingArmor(float scale) {
        ...
        bipedBody.cubeList.add(new ModelBox(bipedBody, 83, 59, 2.0F, 7.0F, 2.5F, 0, 7, 5, 0.0F, false));
        bipedBody.cubeList.add(new ModelBox(bipedBody, 54, 84, -2.0F, 7.0F, 2.5F, 0, 7, 5, 0.0F, false));
        bipedBody.cubeList.add(new ModelBox(bipedBody, 52, 70, -3.0F, 0.0F, 2.5F, 0, 7, 6, 0.0F, false));
        bipedBody.cubeList.add(new ModelBox(bipedBody, 86, 73, -5.0F, 7.0F, -3.0F, 10, 7, 6, 0.0F, false));

        bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 34, 77, -4.5F, -2.75F, -3.0F, 6, 6, 6, 0.0F, false));
        bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 0, 111, -3.65F, 0.25F, -2.5F, 5, 7, 5, 0.0F, false));

        bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 40, 104, -1.35F, 0.25F, -2.5F, 5, 7, 5, 0.0F, true));
        ...
        RightLeg.cubeList.add(new ModelBox(RightLeg, 108, 114, -2.7F, 0.1F, -2.5F, 5, 9, 5, 0.0F, false));

        LeftLeg.cubeList.add(new ModelBox(LeftLeg, 108, 100, -2.3F, 0.1F, -2.5F, 5, 9, 5, 0.0F, true));
